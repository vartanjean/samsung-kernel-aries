...
#define MFC_FW_MAX_SIZE       (512 * 1024) /* 512KB : 2x1024x1024                  */
...
#if defined(CONFIG_S5PV210_XL) || defined(CONFIG_S5PV210_XL) || defined(CONFIG_S5PV210_XL_HUGHMEM) || defined(CONFIG_S5PV210_TESTMEM)
