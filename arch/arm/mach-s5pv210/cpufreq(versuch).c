...
unsigned long hundertmhz(void)
{
    return s5pv210_freq_table[L7].frequency; // 100 mhz
}
EXPORT_SYMBOL(hundertmhz);

unsigned long zweihundertmhz(void)
{
    return s5pv210_freq_table[L6].frequency; // 200 mhz
}
EXPORT_SYMBOL(zweihundertmhz);

unsigned long vierhundertmhz(void)
{
    return s5pv210_freq_table[L5].frequency; // 400 mhz
}
EXPORT_SYMBOL(vierhundertmhz);

unsigned long achthundertmhz(void)
{
    return s5pv210_freq_table[L4].frequency; // 800 mhz
}
EXPORT_SYMBOL(achthundertmhz);

unsigned long tausendmhz(void)
{
    return s5pv210_freq_table[L3].frequency; // 1000 mhz
}
EXPORT_SYMBOL(tausendmhz);
#endif
