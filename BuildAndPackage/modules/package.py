...
def make_boot_img(bootDisk, zImage, recovery = None):
    ...
    except: raise FileAccessError(zImage)
    ...
    except: raise FileAccessError(bootDisk)
    ...
    if recovery:
        ...
        except: raise FileAccessError(recovery)
...
def make_zip(name, tree):
    ...
    try:
        ...
        cwmZip.close()       
    except: raise FileAccessError(name)
...
def prep_compilation(objBImg, config, dirBAP, dirDev, nameDev):
    ...
    except: FileAccessError(locBImg)