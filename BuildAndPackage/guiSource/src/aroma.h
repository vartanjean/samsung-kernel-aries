...
//
#define AROMA_NAME        "Team ICSSGS"
#define AROMA_VERSION     "RC4.2"
#define AROMA_BUILD       "2132012"
#define AROMA_BUILD_CN    "ICS"
#define AROMA_BUILD_L     "Oklahoma - USA"
#define AROMA_BUILD_A     "<http://groups.google.com/group/TeamICSSGS?hl=en&pli=1>"
#define AROMA_BUILD_URL   "http://code.google.com/p/ice-cream-sandwich-sgs/"
#define AROMA_COPY        "Copyright 2012 by Team ICSSGS"
...
#define AROMA_TMP         AROMA_SYSTMP "/icssgs"
#define AROMA_TMP_S       AROMA_SYSTMP "/icssgs-data"

#define AROMA_DIR         "META-INF/com/google/android/icssgs"
#define AROMA_CFG         "META-INF/com/google/android/icssgs-config"
...
typedef struct  {
  ...
  char  compiled_by[32];	//Compiled by: in "About"
